...
> 目前这个库是一个纯 scss 库,你也可以通过 build index.scss 文件生成纯 css 代码,他支持任何使用 scss 的项目
...
@import 'scss-mixin/src/var.scss';
@import 'scss-mixin/src/utils.scss';
@import 'scss-mixin/src/border.scss';
@import 'scss-mixin/src/flex.scss';
@import 'scss-mixin/src/form.scss';
@import 'scss-mixin/src/gap.scss';
@import 'scss-mixin/src/layout.scss';
@import 'scss-mixin/src/others.scss';
@import 'scss-mixin/src/position.scss';
@import 'scss-mixin/src/text.scss';
